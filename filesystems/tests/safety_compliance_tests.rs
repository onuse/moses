...
// Test all formatters
test_formatter_safety!(moses_filesystems::Ext4Formatter, ext4_safety);
test_formatter_safety!(moses_filesystems::NtfsFormatter, ntfs_safety);
test_formatter_safety!(moses_filesystems::Fat32Formatter, fat32_safety);
test_formatter_safety!(moses_filesystems::ExFatFormatter, exfat_safety);

#[cfg(target_os = "windows")]
test_formatter_safety!(moses_filesystems::Ext4NativeFormatter, ext4_windows_safety);

#[cfg(target_os = "windows")]
test_formatter_safety!(moses_filesystems::NtfsWindowsFormatter, ntfs_windows_safety);
