...
fn test_filesystem_info_structs_exist() {
    ...
    // exFAT
    let _exfat_info = moses_formatters::exfat::reader::ExFatInfo {
    ...
    // FAT32
    let _fat32_info = moses_formatters::fat32::reader::FsInfo {
...
async fn test_fat32_volume_label() {
    use moses_formatters::Fat32Formatter;
...
async fn test_exfat_volume_label() {
    use moses_formatters::ExFatFormatter;
